...
public class EditUserInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            Persona editPerson = new Persona(
            ...
            Usuario editUser = (Usuario) session.getAttribute("usuario");
            editUser.setPassword(request.getParameter("PASSWORD"));
            
            UsuarioDAO.updateUsuario(editUser.getId(), editUser, conx);
            PersonaDAO.updatePersona(editPerson.getCurp(), editPerson, conx);
